...
public class FrameButton2 {
    public FrameButton2(ArrayList<Formula1Shofer> drivers) {
        ...
        JFrame frame = new JFrame("Tabela e shofereve te renditur sipas pikeve (ne rend zbrites) ");
